...
func TestDeviceswapCheckWithOptionalParams(t *testing.T) {
	...
	_, err := client.Deviceswap.Check(context.TODO(), camara.DeviceswapCheckParams{
		MaxAge:      camara.Int(120),
		PhoneNumber: camara.String("+34666111333"),
...
func TestDeviceswapGetDateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Deviceswap.GetDate(context.TODO(), camara.DeviceswapGetDateParams{
		PhoneNumber: camara.String("+34666111333"),
		XCorrelator: camara.String("b4333c46-49c0-4f62-80d7-f0ef930f1c46"),
	})
	if err != nil {
