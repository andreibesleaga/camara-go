...
func TestKnowyourcustomermatchMatchWithOptionalParams(t *testing.T) {
	...
	_, err := client.Knowyourcustomermatch.Match(context.TODO(), camara.KnowyourcustomermatchMatchParams{
