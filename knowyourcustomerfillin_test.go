...
func TestKnowyourcustomerfillInNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.KnowyourcustomerfillIn.New(context.TODO(), camara.KnowyourcustomerfillInNewParams{
