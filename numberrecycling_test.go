...
func TestNumberrecyclingCheckSubscriberChangeWithOptionalParams(t *testing.T) {
	...
	_, err := client.Numberrecycling.CheckSubscriberChange(context.TODO(), camara.NumberrecyclingCheckSubscriberChangeParams{
