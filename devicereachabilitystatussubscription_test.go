...
func TestDevicereachabilitystatusSubscriptionNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Devicereachabilitystatus.Subscriptions.New(context.TODO(), camara.DevicereachabilitystatusSubscriptionNewParams{
		Config: camara.DeviceReachabilityStatusConfigParam{
			SubscriptionDetail: camara.DeviceReachabilityStatusConfigSubscriptionDetailParam{
				Device: camara.DeviceReachabilityStatusConfigSubscriptionDetailDeviceParam{
					Ipv4Address: camara.DeviceReachabilityStatusConfigSubscriptionDetailDeviceIpv4AddressParam{
...
func TestDevicereachabilitystatusSubscriptionGetWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestDevicereachabilitystatusSubscriptionListWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Devicereachabilitystatus.Subscriptions.List(context.TODO(), camara.DevicereachabilitystatusSubscriptionListParams{
		XCorrelator: camara.String("b4333c46-49c0-4f62-80d7-f0ef930f1c46"),
	})
	if err != nil {
		var apierr *camara.Error
...
func TestDevicereachabilitystatusSubscriptionDeleteWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
