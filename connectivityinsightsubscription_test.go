...
func TestConnectivityinsightSubscriptionNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Connectivityinsights.Subscriptions.New(context.TODO(), camara.ConnectivityinsightSubscriptionNewParams{
		Config: camara.ConfigParam{
			SubscriptionDetail: camara.ConfigSubscriptionDetailParam{
				...
				Device: camara.ConfigSubscriptionDetailDeviceParam{
					Ipv4Address: camara.ConfigSubscriptionDetailDeviceIpv4AddressParam{
				...
				ApplicationServer: camara.ConfigSubscriptionDetailApplicationServerParam{
					Ipv4Address: camara.String("192.168.0.1/24"),
					Ipv6Address: camara.String("2001:db8:85a3:8d3:1319:8a2e:370:7344"),
				},
				ApplicationServerPorts: camara.ConfigSubscriptionDetailApplicationServerPortsParam{
					Ports: []int64{5060, 5070},
					Ranges: []camara.ConfigSubscriptionDetailApplicationServerPortsRangeParam{{
						From: 5010,
						To:   5020,
					}},
				},
		...
		SinkCredential: camara.ConnectivityinsightSubscriptionNewParamsSinkCredential{
...
func TestConnectivityinsightSubscriptionGetWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestConnectivityinsightSubscriptionListWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Connectivityinsights.Subscriptions.List(context.TODO(), camara.ConnectivityinsightSubscriptionListParams{
		XCorrelator: camara.String("b4333c46-49c0-4f62-80d7-f0ef930f1c46"),
	})
	if err != nil {
		var apierr *camara.Error
...
func TestConnectivityinsightSubscriptionDeleteWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
