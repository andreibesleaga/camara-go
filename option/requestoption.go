...
// RequestOption is an option for the requests made by the camara API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/camara-go#readme-requestoptions
...
func WithDeviceLocationNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.DeviceLocationNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.DeviceLocationNotificationsAPIKey)))
	})
}
...
func WithNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.NotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.NotificationsAPIKey)))
	})
}
...
func WithPopulationDensityDataNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.PopulationDensityDataNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.PopulationDensityDataNotificationsAPIKey)))
	})
}
...
func WithRegionDeviceCountNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.RegionDeviceCountNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.RegionDeviceCountNotificationsAPIKey)))
	})
}
...
func WithConnectivityInsightsNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.ConnectivityInsightsNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.ConnectivityInsightsNotificationsAPIKey)))
	})
}
...
func WithSimSwapNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.SimSwapNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.SimSwapNotificationsAPIKey)))
	})
}
...
func WithDeviceRoamingStatusNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.DeviceRoamingStatusNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.DeviceRoamingStatusNotificationsAPIKey)))
	})
}
...
func WithDeviceReachabilityStatusNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.DeviceReachabilityStatusNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.DeviceReachabilityStatusNotificationsAPIKey)))
	})
}
...
func WithConnectedNetworkTypeNotificationsAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.ConnectedNetworkTypeNotificationsAPIKey = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.ConnectedNetworkTypeNotificationsAPIKey)))
	})
}
