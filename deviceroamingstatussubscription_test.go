...
func TestDeviceroamingstatusSubscriptionNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Deviceroamingstatus.Subscriptions.New(context.TODO(), camara.DeviceroamingstatusSubscriptionNewParams{
		Config: camara.DeviceRoamingStatusConfigParam{
			SubscriptionDetail: camara.DeviceRoamingStatusConfigSubscriptionDetailParam{
				Device: camara.DeviceRoamingStatusConfigSubscriptionDetailDeviceParam{
					Ipv4Address: camara.DeviceRoamingStatusConfigSubscriptionDetailDeviceIpv4AddressParam{
...
func TestDeviceroamingstatusSubscriptionListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Deviceroamingstatus.Subscriptions.List(context.TODO(), camara.DeviceroamingstatusSubscriptionListParams{
		XCorrelator: camara.String("b4333c46-49c0-4f62-80d7-f0ef930f1c46"),
	})
	if err != nil {
		var apierr *camara.Error
