...
<a href="https://pkg.go.dev/github.com/andreibesleaga/camara-go"><img src="https://pkg.go.dev/badge/github.com/andreibesleaga/camara-go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/andreibesleaga/camara-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/andreibesleaga/camara-go/option).
...
`*camara.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `camara.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/andreibesleaga/camara-go/issues) with questions, bugs, or suggestions.
