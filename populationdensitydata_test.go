...
func TestPopulationdensitydataGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Populationdensitydata.Get(context.TODO(), camara.PopulationdensitydataGetParams{
		...
		SinkCredential: camara.PopulationdensitydataGetParamsSinkCredential{
