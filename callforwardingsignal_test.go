...
func TestCallforwardingsignalCheckActiveForwardingsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Callforwardingsignal.CheckActiveForwardings(context.TODO(), camara.CallforwardingsignalCheckActiveForwardingsParams{
...
func TestCallforwardingsignalCheckUnconditionalForwardingWithOptionalParams(t *testing.T) {
	t.Skip("Prism tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Callforwardingsignal.CheckUnconditionalForwarding(context.TODO(), camara.CallforwardingsignalCheckUnconditionalForwardingParams{
		CreateCallForwardingSignal: camara.CreateCallForwardingSignalParam{
			PhoneNumber: camara.String("+123456789"),
		},
		XCorrelator: camara.String("b4333c46-49c0-4f62-80d7-f0ef930f1c46"),
